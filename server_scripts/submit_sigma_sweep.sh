...
"
    ...
    SBATCH_CMD="sbatch \
        ...
        --wrap='cd $PROJECT_ROOT && export PYTHONPATH=$PROJECT_ROOT:\$PYTHONPATH && . /BS/dniazi_thesis/work/miniforge3_new/etc/profile.d/conda.sh && conda activate smoothing && $RUN_CMD'"
