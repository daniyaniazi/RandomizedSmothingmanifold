...
#SBATCH -o /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/vae-celeba-%j.out
#SBATCH -e /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/vae-celeba-%j.err
#SBATCH -J vae-celeba
