#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# Train 44 smoothed classifiers for CelebA-HQ  (re-submittable, max 48 h)
...
#
# Submit:
#   sbatch server_scripts/submit_smooth_classifiers_celebahq.sh
# ─────────────────────────────────────────────────────────────────────────────
#SBATCH -p gpu20
#SBATCH -t 48:00:00
#SBATCH --gres gpu:1
...
#SBATCH -o /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/smooth-classifiers-celebahq-%j.out
#SBATCH -e /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/smooth-classifiers-celebahq-%j.err
#SBATCH -J smooth-clf-celebahq
...
echo "  Re-submit the same job to continue any remaining/failed runs."
  echo "  Checkpoints: $BASE_CKPT/{isotropic,manifold}/celebahq/smile_resnet18_celebahq_sigma_*/best.pt"