...
#SBATCH -o /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/smooth-celebahq-%A_%a.out
#SBATCH -e /BS/dniazi_thesis/work/RandomizedSmothingmanifold/output/slurm/smooth-celebahq-%A_%a.err
#SBATCH -J smooth-celebahq
